...
const Glossary = (() => {
  ...
  { id: 'xp', term: 'エクストリーム・プログラミング', aliases: ['XP', 'Extreme Programming'], category: 'フレームワーク',
    definition: 'XPはExtreme Programming（エクストリーム・プログラミング）の略で、ペアプログラミングや継続的インテグレーションなど、ソフトウェア開発の技術的プラクティスに重点を置いたアジャイル手法。' },

  // --- 役割・チームマネジメント ---
  { id: 'product-owner', term: 'プロダクト・オーナー', aliases: ['プロダクト・オーナー', 'PO'], category: '役割・チーム',
    definition: 'POはProduct Owner（プロダクト・オーナー）の略で、プロダクトの価値を最大化する責任を負い、プロダクト・バックログの優先順位付けや意思決定を行う役割。アジャイルにおける顧客代理・ビジネス責任者。' },
  { id: 'scrum-master', term: 'スクラム・マスター', aliases: ['スクラム・マスター', 'SM'], category: '役割・チーム',
    definition: 'SMはScrum Master（スクラム・マスター）の略で、チームを支援し、障害を取り除き、チームが持続可能なペースで作業できるようにするサーバント・リーダー役。' },
  ...
  { id: 'emotional-intelligence', term: '感情知能（EQ）', aliases: ['感情知能', 'EQ', 'EI'], category: '役割・チーム',
    definition: 'EQはEmotional Quotient、EIはEmotional Intelligenceの略で、自分と他者の感情を認識・理解・管理し、対人関係やチームのモチベーションを良好に保つ能力。' },
  ...
  { id: 'raci-chart', term: 'RACIチャート', aliases: ['RACI', 'RACIマトリクス'], category: '役割・チーム',
    definition: 'RACIはResponsible、Accountable、Consulted、Informedの頭字語で、タスクごとに「実行責任者(R)」「説明責任者(A)」「協働/相談先(C)」「報告先(I)」を明確にする責任割り当てマトリクス。',
  ...
  { id: 'wbs', term: '作業分解構成案（WBS）', aliases: ['WBS', '作業分解構成案'], category: '成果物・ドキュメント',
    definition: 'WBSはWork Breakdown Structure（作業分解構成案）の略で、プロジェクト成果物を管理しやすい小さな構成要素（ワーク・パッケージ）へ階層的に要素分解した図・表。',
  ...
  { id: 'dod', term: 'Doneの定義（DoD）', aliases: ['Doneの定義', 'DoD', '完成の定義'], category: '見積り・指標',
    definition: 'DoDはDefinition of Doneの略で、作業項目や成果物が「完了」したとみなされるために満たすべき品質・検証の共通基準。' },
  { id: 'dor', term: 'Readyの定義（DoR）', aliases: ['Readyの定義', 'DoR', '準備完了の定義'], category: '見積り・指標',
    definition: 'DoRはDefinition of Readyの略で、バックログ項目がスプリントでの開発に着手可能と判断されるために必要な要件（定義の明確化など）。' },
  { id: 'evm', term: 'アーンド・バリュー・マネジメント（EVM）', aliases: ['EVM', 'アーンドバリュー分析'], category: '見積り・指標',
    definition: 'EVMはEarned Value Management（アーンド・バリュー・マネジメント）の略で、スコープ・スケジュール・コストの進捗と実績値を金額に換算して統合的に評価・予測するパフォーマンス管理手法。',
  ...
  { id: 'pv', term: '計画値（PV）', aliases: ['PV', 'Planned Value'], category: '見積り・指標',
    definition: 'PVはPlanned Value（計画値）の略で、指定された日までに完了する予定であった作業に割り当てられていた承認済みの予算（計画コスト）。',
  ...
  { id: 'ev', term: '出来高（EV）', aliases: ['EV', 'Earned Value'], category: '見積り・指標',
    definition: 'EVはEarned Value（出来高）の略で、実際に完了した作業に対して承認されていた予算額。獲得した価値を示す。',
  ...
  { id: 'ac', term: '実コスト（AC）', aliases: ['AC', 'Actual Cost'], category: '見積り・指標',
    definition: 'ACはActual Cost（実コスト）の略で、指定された日までに実行した作業のために実際に発生したコストの総額。',
    example: '例：同じプロジェクトで、5日目終了時点までにその作業のため実際に支出した金額はAC＝¥450,000。' },
  { id: 'cv', term: 'コスト差異（CV）', aliases: ['CV', 'Cost Variance', 'CV(EVM)'], category: '見積り・指標',
    definition: 'CVはCost Variance（コスト差異）の略で、出来高（EV）から実コスト（AC）を差し引いた値（CV = EV - AC）。CVが正なら予算内、負なら予算超過を示す。' },
  { id: 'cpi', term: 'コスト効率指数（CPI）', aliases: ['CPI'], category: '見積り・指標',
    definition: 'CPIはCost Performance Index（コスト効率指数）の略で、コスト効率を示す指標（EV ÷ AC）。1.0以上なら予算内、1.0未満なら予算オーバー。',
  ...
  { id: 'spi', term: 'スケジュール効率指数（SPI）', aliases: ['SPI'], category: '見積り・指標',
    definition: 'SPIはSchedule Performance Index（スケジュール効率指数）の略で、スケジュール効率を示す指標（EV ÷ PV）。1.0以上なら進捗良好、1.0未満なら計画より遅延。',
  ...
  { id: 'cpm', term: 'クリティカル・パス法（CPM）', aliases: ['クリティカル・パス法', 'CPM', 'クリティカルパス'], category: '見積り・指標',
    definition: 'CPMはCritical Path Method（クリティカル・パス法）の略で、プロジェクトの最長経路（トータルフロートがゼロの経路）を特定し、最短完了期間を算出するスケジュール分析手法。',
  ...
  { id: 'roi', term: '投資収益率（ROI）', aliases: ['ROI', '投資収益率', 'Return on Investment'], category: '見積り・指標',
    definition: 'ROIはReturn on Investment（投資収益率）の略で、投資から得られた利益を投資額で割って表す指標。一般に ROI = (利益 - 投資額) ÷ 投資額 で計算し、値が高いほど投資効率が高いことを示す。',
  ...
  { id: 'cost-benefit-analysis', term: '費用便益分析（Cost-Benefit Analysis）', aliases: ['費用便益分析', 'コスト便益分析', 'Cost-Benefit Analysis', 'CBA'], category: '見積り・指標',
    definition: 'CBAはCost-Benefit Analysis（費用便益分析）の略で、想定される便益と必要コストを比較し、投資や実行可否の妥当性を評価する分析手法。ROI、NPV、回収期間などの指標と併用される。',
    relatedQuestionIds: [145] },
  { id: 'npv', term: '正味現在価値（NPV）', aliases: ['NPV', '正味現在価値', 'Net Present Value'], category: '見積り・指標',
    definition: 'NPVはNet Present Value（正味現在価値）の略で、将来のキャッシュフローを割引率で現在価値に換算し、初期投資を差し引いた価値。通常、NPVが正なら経済的に実行価値があると判断される。' },
  ...
  { id: 'mvp', term: '最小実行可能プロダクト（MVP）', aliases: ['最小実行可能プロダクト', 'MVP'], category: 'デリバリー戦略',
    definition: 'MVPはMinimum Viable Product（最小実行可能プロダクト）の略で、アーリーアダプターに価値を提供し、実際のフィードバックを得て仮説検証・学習するために必要な最小限の機能を持つプロダクト。' },
  { id: 'mmp', term: '最小商用可能プロダクト（MMP）', aliases: ['最小商用可能プロダクト', 'MMP'], category: 'デリバリー戦略',
    definition: 'MMPはMinimum Marketable Product（最小商用可能プロダクト）の略で、一般市場の顧客に向けてリリースし、ビジネス成果を収益化できる最小限の完成度を持つプロダクト。' },
  ...
  { id: 'risk-management-plan', term: 'リスクマネジメント計画書', aliases: ['リスクマネジメント計画書', 'Risk Management Plan'], category: 'リスク・変更',
    definition: 'リスクの特定・分析・対応・監視をどのように進めるか、役割、手法、頻度、しきい値、報告方法を定義した計画書。' },
  ...
  { id: 'root-cause-analysis', term: '根本原因分析（RCA）', aliases: ['根本原因分析', 'RCA', 'なぜなぜ分析', 'フィッシュボーン'], category: '分析手法',
    definition: 'RCAはRoot Cause Analysis（根本原因分析）の略で、問題の表面的な症状だけでなく、事象を引き起こした本質的な因果関係（根本原因）を特定して是正する分析手法。' },
  { id: 'field-test', term: 'フィールドテスト', aliases: ['フィールドテスト', 'Field Test'], category: '分析手法',
    definition: '実際の利用環境またはそれに近い条件下で製品や成果物を検証し、机上検証では見えにくい課題や運用上のリスクを確認するテスト手法。' },
  { id: 'six-sigma', term: 'シックスシグマ', aliases: ['シックスシグマ', 'Six Sigma'], category: '分析手法',
    definition: '統計的手法を用いてプロセスのばらつきと欠陥を低減し、品質を継続的に改善するマネジメント手法。DMAIC（定義・測定・分析・改善・管理）サイクルで進める。' },
  ...
  { id: 'initiative', term: 'イニシアチブ', aliases: ['イニシアチブ', 'Initiative'], category: 'ビジネス環境',
    definition: '組織の戦略目標を達成するために立ち上げる、複数の活動・プロジェクトを含み得る計画的な取り組み。' },
  ...
  { id: 'eef', term: '組織体の環境要因（EEF）', aliases: ['EEF', '組織体の環境要因'], category: 'ビジネス環境',
    definition: 'EEFはEnterprise Environmental Factors（組織体の環境要因）の略で、プロジェクトチームの制御外であり、プロジェクトに影響・制約・指示を与える内外の環境条件（企業文化、市場動向、インフラ等）。' },
  { id: 'opa', term: '組織のプロセス資産（OPA）', aliases: ['OPA', '組織のプロセス資産'], category: 'ビジネス環境',
    definition: 'OPAはOrganizational Process Assets（組織のプロセス資産）の略で、組織が蓄積してきた計画、プロセス、ポリシー、標準手順、過去の知識ベースやテンプレートなどの内部資産。' },
